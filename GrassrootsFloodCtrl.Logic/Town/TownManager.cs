...
{
    public class TownManager : ManagerBase, ITownManager
    {
        ...
        /// <returns></returns>
        public BsTableDataSource<TownPersonLiableViewModel> GetTownList(GetTownList request)
        {
        ...
        public TownPersonLiable GetTownByName(string name, string post, string position, string mobile, string remark, string id)
        {
            using (var db = DbFactory.Open())
            {
                if (id != "")
